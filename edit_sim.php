    ...
    if (isset($_GET['id'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            <form action="update_sim.php" method="post">
                ...
                <input type="text" id="currentcourse" name="currentcourse" value="<?php echo $currentcourse; ?>"
                    required><br><br>

                <label for="previouscourse">Previous Course:</label><br>
                <input type="text" id="previouscourse" name="previouscourse" value="<?php echo $previouscourse; ?>"
                    required><br><br>

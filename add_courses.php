                        ...
                        <div class="col-md-6">
                            <form action="submit_course.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="course_fees" name="course_fees" class="form-control"
                                        required><br><br>
                                    ...
                                    <input type="text" id="schedule" name="schedule" class="form-control"
                                        placeholder="E.g., Monday 10:00 AM - 12:00 PM" required><br><br>
                                    ...
                                    <input type="number" id="enrollment_limit" class="form-control"
                                        name="enrollment_limit" required><br><br>

                                    <label for="resources_needed">Resources Needed:</label>
                                    <input type="text" id="resources_needed" name="resources_needed"
                                        class="form-control" required><br><br>

                                    <label for="grading_scale">Grading Scale:</label>
                                    <input type="text" id="grading_scale" name="grading_scale" class="form-control"
                                        required><br><br>

                                    <label for="assessment_methods">Assessment Methods:</label>
                                    <input type="text" id="assessment_methods" name="assessment_methods"
                                        class="form-control" required><br><br>

                                    <label for="communication_channels">Communication Channels:</label>
                                    <input type="text" id="communication_channels" name="communication_channels"
                                        class="form-control" required><br><br>

                                    <label for="additional_notes">Additional Notes:</label><br>
                                    <textarea id="additional_notes" name="additional_notes" rows="4" cols="50"

                        ...
                        <div class="col-md-6">
                            <form action="submit_new_faculty.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="address" class="form-control" name="address" rows="4"
                                    ...
                                    <textarea id="experience" class="form-control" name="experience"
                                        rows="4"></textarea><br>

                                    <label for="teaching">Teaching Specializations:</label><br>
                                    <textarea id="teaching" class="form-control" name="teaching"
                                        rows="4"></textarea><br>

                                    <label for="research">Research and Publications:</label><br>
                                    <textarea id="research" class="form-control" name="research"
                                        rows="4"></textarea><br>
                                    ...
                                    <textarea id="memberships" class="form-control" name="memberships"
                                        rows="4"></textarea><br>

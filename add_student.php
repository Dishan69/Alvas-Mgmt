                        ...
                        <div class="col-md-6">
                            <form action="submit_student.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="emergency_contact_person" class="form-control"
                                        name="emergency_contact_person"><br>
                                    ...
                                    <input type="text" id="emergency_contact_number" class="form-control"
                                        name="emergency_contact_number"><br>
                                    ...
                                    <input type="email" id="guardian_email" class="form-control"
                                        name="guardian_email"><br>

                                    <label for="guardian_contact_number">Guardian's Contact Number:</label><br>
                                    <input type="text" id="guardian_contact_number" class="form-control"
                                        name="guardian_contact_number"><br>

                                    <label for="student_photo">Photo:</label><br>
                                    <input type="file" id="student_photo" accept="image/*" class="form-control"
                                        name="student_photo"><br>
                                    ...
                                    <input type="number" id="admission_year" class="form-control"
                                        name="admission_year"><br>


                                    <label for="batch">Date Of Admission:</label><br>
                                    <input type="date" id="date_of_admission" class="form-control"
                                        name="date_of_admission"><br>

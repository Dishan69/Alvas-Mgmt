...
<body>
    <div class="sidebar" style="width:300px">
        <img src="image/s2.jpg" alt="your logo">
        ...
        if ($usertype === 'student') {
            ...
            <nav class="navbar">
                <ul>
                    <li>
                        <a href="student_dashboard.php" style='font-size:22px'>Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li><a href="view_extracurricular_activities.php" style='font-size:16px'>View extracurricular
                                    activities</a></li>
                        </ul>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="view_update_faculty.php" style='font-size:16px'>Update Faculty/Staff
                                    information</a></li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li><a href="enroll_student.php" style='font-size:16px'>Registration Management(For Student)</a>
                            </li>
                            <li><a href="enroll_staff.php" style='font-size:16px'>Registration Management(For Staff)</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li><a href="add_extracurricular_activities.php" style='font-size:16px'>Extracurricular
                                    activities(New)</a></li>
                            <li><a href="view_update_extracurricular_activities.php" style='font-size:16px'>Extracurricular
                                    activities(Update)</a></li>
                            <li><a href="view_extracurricular_activities.php" style='font-size:16px'>Extracurricular
                                    activities(View)</a></li>
                        </ul>
                    </li>

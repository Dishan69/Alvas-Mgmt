            ...
            <div class="content">
                <div class="widget">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="submit_extracurricular_activity.php" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="activity_description" class="form-control"
                                        name="activity_description"></textarea><br>
                                    ...
                                    <input type="datetime-local" class="form-control" id="activity_datetime"
                                        name="activity_datetime"><br>

                                    <label for="activity_location">Location:</label><br>
                                    <input type="text" id="activity_location" class="form-control"
                                        name="activity_location"><br>

                                    <label for="activity_organizer">Organizer:</label><br>
                                    <input type="text" id="activity_organizer" class="form-control" class="form-control"
                                        name="activity_organizer"><br>

                                    <label for="activity_requirements">Participant Requirements:</label><br>
                                    <textarea id="activity_requirements" name="activity_requirements"
                                        class="form-control"></textarea><br>

                                    <label for="registration_deadline">Registration Deadline:</label><br>
                                    <input type="date" id="registration_deadline" class="form-control"
                                        name="registration_deadline"><br>

                                    <label for="activity_contact">Contact Information:</label><br>
                                    <input type="text" id="activity_contact" class="form-control"
                                        name="activity_contact"><br>

                                    <label for="activity_image">Image/Logo:</label><br>
                                    <input type="file" id="activity_image" class="form-control" accept="image/*"
                                        name="activity_image"><br>

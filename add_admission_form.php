                        ...
                        <div class="col-md-6">
                            <form action="submit_application.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="prev_school" name="prev_school" class="form-control"
                                        required><br><br>
                                    ...
                                    <input type="number" id="gpa" name="gpa" step="0.01" class="form-control"
                                        required><br><br>
                                    ...
                                    <input type="number" id="toefl_score" name="toefl_score"
                                        class="form-control"><br><br>


                                    <label for="activities">Extracurricular Activities:</label>
                                    <textarea id="activities" name="activities" rows="3" cols="30"
                                        class="form-control"></textarea><br><br>

                                    <label for="volunteer_exp">Volunteer Experience:</label>
                                    <textarea id="volunteer_exp" name="volunteer_exp" rows="3" cols="30"
                                        class="form-control"></textarea><br><br>


                                    <label for="personal_statement">Personal Statement:</label><br>
                                    <textarea id="personal_statement" name="personal_statement" rows="5" cols="50"
                                        class="form-control"></textarea><br><br>
                                    ...
                                    <input type="file" id="recommendation" name="recommendation"
                                        accept="application/pdf" class="form-control"><br><br>

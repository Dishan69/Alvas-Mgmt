                            ...
                            <div class="col-md-6">
                                <form action="submit_curriculum.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <textarea id="educational_goals" name="educational_goals" rows="4" cols="50"
                                            required></textarea><br><br>
                                        ...
                                        <input type="text" id="learning_standards" name="learning_standards"
                                            required><br><br>

                                        <label for="instructional_materials">Instructional
                                            Materials/Resources:</label><br>
                                        <textarea id="instructional_materials" name="instructional_materials" rows="4"
                                            cols="50" required></textarea><br><br>

                                        <label for="assessment_methods">Assessment Methods:</label><br>
                                        <textarea id="assessment_methods" name="assessment_methods" rows="4" cols="50"
                                            required></textarea><br><br>

                                        <label for="implementation_timeline">Implementation Timeline:</label>
                                        <input type="text" id="implementation_timeline" name="implementation_timeline"
                                            required><br><br>

                                        <label for="budget_allocation">Budget Allocation:</label>
                                        <input type="number" id="budget_allocation" name="budget_allocation"
                                            required><br><br>

                                        <label for="staffing_requirements">Staffing Requirements:</label><br>
                                        <textarea id="staffing_requirements" name="staffing_requirements" rows="4"
                                            cols="50" required></textarea><br><br>

                                        <label for="professional_development">Professional Development
                                            Needs:</label><br>
                                        <textarea id="professional_development" name="professional_development" rows="4"
                                            cols="50" required></textarea><br><br>

                                        <label for="evaluation_plan">Evaluation Plan:</label><br>
                                        <textarea id="evaluation_plan" name="evaluation_plan" rows="4" cols="50"
                                            required></textarea><br><br>

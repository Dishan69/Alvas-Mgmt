                        ...
                        <div class="col-md-6">
                            <form action="submit_curriculum.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="curriculum_name" class="form-control" name="curriculum_name"
                                        required><br><br>

                                    <label for="curriculum_code">Curriculum Code/ID:</label>
                                    <input type="text" id="curriculum_code" class="form-control" name="curriculum_code"
                                        required><br><br>

                                    <label for="description">Description:</label><br>
                                    <textarea id="description" name="description" rows="4" cols="50"
                                        class="form-control" required></textarea><br><br>

                                    <label for="educational_goals">Educational Goals/Objectives:</label><br>
                                    <textarea id="educational_goals" name="educational_goals" class="form-control"
                                        rows="4" cols="50" required></textarea><br><br>

                                    <label for="grade_levels">Grade Levels:</label>
                                    <input type="text" id="grade_levels" name="grade_levels" class="form-control"
                                        required><br><br>
